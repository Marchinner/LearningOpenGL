...
int main()
{
	...
	{
		std::cout << "Failed to load texture awasomeface" << std::endl;
	}
	stbi_image_free(data);
	...
	unsigned int lighBoxVBO;
	glGenBuffers(1, &lighBoxVBO);
	glBindBuffer(GL_ARRAY_BUFFER, lighBoxVBO);
	...
	Shader lightShader("./src/lightBoxVertex.glsl", "./src/lightBoxFragment.glsl");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		lightShader.setVec3("lighPos", lightPos);
		glBindVertexArray(lightBoxVAO);
